...
export default function Offering(){
   ...
   return(
      <div className='Offering text-center row align-items-center'>
         <div>
            <HeaderH1 title='DEAL TODAY'/>
            <HeaderH4 title='Limited Offer 70% Off Until Tomorrow'/>
            <Description desc='Spesial diskon untuk produk SNEAKERS' />
